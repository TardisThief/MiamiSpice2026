...
import { IconTarget, IconChevronRight, IconSliders } from './Icons.jsx';
...
function markerIcon(record, isSelected) {
  ...
  const size = tier === 'neighborhood_only' || tier === 'unknown' ? 14 : 20;
  ...
  return (
    <div className="peek" role="dialog" aria-label={record.name}>
      ...
      <div className="peek__side">
        ...
        <IconChevronRight width={18} height={18} className="peek__chev" />
      </div>
    </div>
  );
}

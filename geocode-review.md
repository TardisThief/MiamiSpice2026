...
Generated 2026-08-03 · 380 records
...
| `poi_match` | 92 | 24.2% | solid pin |
| `address_exact` | 228 | 60.0% | solid pin |
| `approximate` | 60 | 15.8% | hollow pin + "approximate location" |
...
**60** record(s) need review · **320** are solid.

307 of 380 coordinates were confirmed by two or more independent methods agreeing within 150 m.
